...
//deklaruojami.....
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(BluetoothDevice.ACTION_FOUND.equals(action)){
                ...
                if(adapterAvailableDevices.getCount()==0){
                    Toast.makeText(context,"Naujų įrenginių nerasta", Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(context,"Pasirinkite įrenginį", Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.menu_scan_devices:
                Toast.makeText(context,"Paspaudėte ieškoti įrenginių", Toast.LENGTH_SHORT).show();
                scanDevice();
                return true;
            default:
    ...
    Toast.makeText(context,"Ieškoma įrenginių", Toast.LENGTH_SHORT).show();
